...
function openGlass() {
  ...
  gsap.to(".projects", {display: "flex", delay: 6.5});
...
tlAbout.from(".aboutLines div", {duration: 1, width: 0, ease: "back"});
tlAbout.from(".aboutCard", {duration: 1.2, height: 0, opacity: 0, ease: "power2"});
tlAbout.from(".aboutCardInfo", {height: 0, opacity: 0, ease: "power4"});